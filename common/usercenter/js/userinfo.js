                ...
                methods: {
                    initData: function (flag) {
                        ...
                        httpUser.detail().then(function (res) {
                            ...
                            formData.attachmentIdUrl = formData.headImg ? formData.headImg.url : '';
                            formData.qualifications.length && (formData.qualifications = formData.qualifications.map(function (t) {
                                return t.tagId
                            }))
                            formData.headImg = formData.headImg ? formData.headImg.id : '';
