            ...
            window.vueDom = new Vue({
                ...
                methods: {
                    ...
                    getTechTreceiveProject: function (form) {
                        var _this = this;
                        userCenterApi.find_my_receive_project(form).then(function (res) {
                            console.log(res)
                            if (!res.code) {
                    ...
                    getTechReceiveInvitation: function (form) {
                        var _this = this;
                        userCenterApi.find_my_receive_invitation(form).then(function (res) {
                            console.log(res)
                            if (!res.code) {
                                _this.$dialog.showToast(res.message);
                                return;
                    ...
                    getTechReceiveEntrust: function (form) {
                        var _this = this;
                        userCenterApi.pageListMyReceivedDelegation(form).then(function (res) {
                            console.log(res)
                            if (!res.code) {
                                _this.$dialog.showToast(res.message);
                                return;
                    ...
                    handleAcccept(item) {
                        ...
                        userCenterApi.accept_create_order(id).then(function (res) {
                            ...
                            _this.search_receive_Entrust_list();
                        })
