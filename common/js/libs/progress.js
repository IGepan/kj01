function progress(options) {
	this.w = options.width || '100%'//(options && options.width) ? parseFloat(options.width) : parseFloat(this.options.width);
	this.h = options.height || '30px'//(options && options.height) ? parseFloat(options.height) : parseFloat(this.options.height);
...
progress.prototype.init = function() {
	...
	this.proBox.setAttribute("style", "width:" + this.w + "; height:" + this.h + "; position:relative; overflow:hidden; box-shadow:0 0 5px #FFFFFF; -moz-box-shadow:0 0 5px #FFFFFF; -webkit-box-shadow:0 0 5px #FFFFFF; -o-box-shadow:0 0 5px #FFFFFF;");
	...
	if(this.showPresent) {
		this.proFont.setAttribute("style", "overflow:hidden;text-overflow:ellipsis; white-space:nowrap; *white-space:nowrap; width:100%; height:100%; color:" + this.fontColor + "; text-align:center; line-height:" + this.h + "; z-index:3; position:absolute; font-size:12px;");
