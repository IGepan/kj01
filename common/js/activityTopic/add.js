...
require([baseUrlPath + '/common/js/require.config.js'], function () {
  require(['jquery', 'vue', 'dic', 'httpVueLoader', 'userCenter', 'httpUser', '/common/js/httpApi/topic.js', '/common/js/httpApi/activity.js', 'jqValidate', 'dialog', 'httpUrl', 'laydate', 'jqSelect', 'VueUeditor'], function ($, Vue, dic, httpVueLoader, userCenter, httpUser, activityApi, activityApi1, jqValidate, dialog, httpUrl, laydate, jqSelect, VueUeditor) {
          ...
          $('.valiform').validate('submitValidate', function (val) {
            if (val) {
              ...
              activityApi[type](data).then(function (res) {
                if (res.code === 'rest.success') {
                  setTimeout(() => {
                    location.href = this.$pathPrefix+'/common/activityTopic/?code=001.004.001.002'
                  }, 2000);
                } else {
