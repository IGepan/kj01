  ...
  var configs = [
    {
      ...
      assisUrl: 'http://172.16.9.34:9769/tsAssistant',
      statisticsUrl: 'http://172.28.143.165:9764', // 统计地址 配置域名
      imgUploadUrl: 'http://172.16.9.34:9769', // 文件上传服务 配置域名
      imgVerify: 'http://captcha.liyantech.cn/', // 滑块验证码 配置域名
      // imgVerify: 'http://172.16.9.34:8720/', // 滑块验证码 配置域名
      // cmsUrl: 'https://cynews.liyantech.cn',
      companyApi: 'https://www.dsjscpx.com',
      bigData: 'http://47.105.63.195:801/',
      datacq: 'https://www.datacq.com.cn/'
