<template>
  <button class="edithead" ref="edithead">
  ...
  mounted: function () {
    ...
    _this.after(
      '<div class="cover"><div class="ctr"><div class="imguploader" style="width:' +
        ...
        "px; height:" +
        ha +
        'px"><div class="t">编辑并上传图片<div class="cls"><div class="iconfont icon-jia"></div></div></div><div class="c"></div></div></div></div>'
    );
    ...
    obj
      ...
      .html(
        '<iframe style="height:' +
          (ha - 34) +
          'px" src="/common/js/imguploader/index.html?w=' +
          wh[0] +
          "&h=" +
          wh[1] +
          "&b=" +
