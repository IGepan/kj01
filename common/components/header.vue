  ...
  <div class="userbanner">
    <div class="mdiv">
      <a
        ...
        class="logo"
      ><img
          :src="webInfo.logoUrl?webInfo.logoUrl:'/style/images/logos/blue-h66.png'"
          alt=""
        /></a>
      <div class="umenu">
        <a
        ...
        >用户中心</a>
        <a
          :href="$pathPrefix+'/common/usercenter/user_information.html?code=001.003.001.001'"
...
module.exports = {
  ...
  components: {
    'ly-searchbox': httpVueLoader(window.$pathPrefix+'/style/components/searchbox.vue')
  },
  methods: {
    getPublicDetail(){
      let vm=this;
