<template>
  <div class="upload_box">
    <input type="file" @change="fileChange" :accept="accept" class="imgipt" />
    <div class="pro" v-if="isUploading"></div>
    <slot></slot>
  </div>
</template>
  ...
  methods: {
    ...
    initPro: function () {
      ...
      if (!this.nopro) {
        ...
        document
          .getElementsByClassName("pro")[0]
          .appendChild(this.pro.getBody());
      }
    },
