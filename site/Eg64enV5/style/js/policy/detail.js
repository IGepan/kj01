...
require(['/common/js/require.config.js'], function () {
	require(['jquery', 'vue', 'dic', 'httpVueLoader',
		'./style/js/api/policy.js', 'httpUrl','fileSaver'],
				...
				mounted: function() {
					...
					document.addEventListener('scroll', function(e) {
						...
						if (vm.clientHeight + vm.scrollTop < vm.scrollHeight) {
							!vm.isFixed && (vm.isFixed = true, vm.styles.left = document.querySelector('.article').offsetLeft);
						} else {
							vm.isFixed && (vm.isFixed = false, vm.styles.left = 0);
						}
					})
					window.addEventListener('resize', function () {
						vm.styles.left = document.querySelector('.article').offsetLeft
					})
				},
				methods: {
					...
					setIsFixed: function () {
						this.$nextTick(function() {
							...
							this.scrollHeight > this.clientHeight && (this.isFixed = true, this.styles.left = document.querySelector('.article').offsetLeft);
						})
					},
