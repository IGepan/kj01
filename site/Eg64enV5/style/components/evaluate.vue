            ...
            <div class="evaluate-row" :key="ei">
              ...
              <div class="vaMiddle evaluate-stars">
                <template v-for="i in 5">
                  <span @click.stop="handleChooseStar" :data-value="i" :data-index="ei" :key="ei + '_index_' + i"  class="vaMiddle iconfont-template"
...
.evaluate-row .evaluate-stars .iconfont-template {
  margin-right: 22px;
  font-size: 23px;
  cursor: pointer;
}
