<template>
  <div class="wb-scrollBox">
    <span @click.stop="handlePrev" class="scrollLeft"><i class="iconfont icon-fanhui"></i></span>
    <span @click.stop="handleNext" class="scrollRight"><i class="iconfont icon-gengduokuozhe"></i></span>
...
.wb-scrollBox .scrollLeft:hover .iconfont, .wb-scrollBox .scrollRight:hover .iconfont {
  color: #fff;
}
</style>
