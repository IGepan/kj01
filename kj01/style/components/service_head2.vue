<template>
  <div class="template-head">
    <div class="headerBox" :class="{ headerBox_line: bottomBorder }">
      <div class="mdiv">
        <div class="headers">
          <div class="header-logo">
            <a href="/market/index.html" class="header-logo_sublogo"
              ><img src="/style/images/logos/bsublogo.png" alt=""
            /></a>
            <span class="header-label">{{ name }}</span>
          </div>
          <div class="headers-right">
            <div class="searchBox" :class="{ foucs: isfoucs }">
      ...
      <div class="mdiv">
        <ul class="nav">
          <template v-for="(nav, ni) in navs">
            <li :class="{ active: nav.active }" :key="ni">
              <a :href="nav.url">{{ nav.label }}</a>
            </li>
          </template>
        </ul>
      </div>
      <div v-if="!breadcrumb.length" class="banner"></div>
    </div>
    <div class="placeBox" v-if="breadcrumb.length">
      <div class="mdiv">
        <div class="breadcrumb">
          当前位置：<span class="breadcrumb__item"><a href="/">首页</a></span
          ><template v-for="(item, i) in breadcrumb">
            <span class="breadcrumb__item" :key="'breadcrumb_' + i"
