...
require(['/common/js/require.config.js'], function () {
  require(['jquery', 'vue', 'httpVueLoader', '/style/js/api/polist.js', 'laydate', 'httpUrl','httpUser','/style/js/api/policyMatch.js',],
      function ($, Vue, httpVueLoader, indexApi, laydate, httpUrl, httpUser,httpPolicy) {
        new Vue({
          el: '#index_box',
          data: {
