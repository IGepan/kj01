...
require([baseUrlPath + '/common/js/require.config.js'], function () {
  require(['jquery', 'vue', 'dic', 'httpVueLoader', 'userCenter', 'httpUser', '/style/js/api/vote.js', 'jqValidate', 'dialog', 'httpUrl', 'laydate'],
    function ($, Vue, dic, httpVueLoader, userCenter, httpUser, voteApi, jqValidate, dialog, httpUrl, laydate) {
      ...
      methods: {
        ...
        getOrderList: function () {
          ...
          if (!this.endIsGreaterThanThebeginning(this.queryForm.activeStartTimeFrom, this.queryForm.activeStartTimeTo)) {
            voteApi.selectByPage(this.queryForm).then(function (res) {
        ...
        isActiveLock: function (id) {
          ...
          //   if (res.code === 'rest.success') {
              vm.$utils.openNewTable('add.html?code=001.004.001.002', '_self')
          //   }
          // });
        }
      }
