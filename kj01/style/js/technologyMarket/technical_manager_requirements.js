                ...
                methods: {
                    ...
                    addProject: function(){
                        ...
                        if (this.userInfo && this.userInfo.userName) {
                            window.location.href = '/common/usercenter/user_market_tech_require.html?id='+vm.id;
                        } else {
                    ...
                    sendPros: function(args){
                        var vm = this;
                            //通过requestType申请类型区分:
                            // 向经纪人发起“投递”技术成果业务（委托成果）1 
                            // 向经纪人发起“委托经纪人”寻找技术成果需求业务(委托需求) 2 
                            // 向经纪人发起“邀约”业务 3
                            var form = {
                       ...
                       getTechAchiListPage: function () {
                        ...
                        indexApi.find_technology_require_pages(form).then(function (res) {
                            console.log(res)
                            if (!res.code) {
