require(['/common/js/require.config.js'], function () {
  require([
    ...
    '../../common/components/alert/index.js'],
      ...
      new Vue({
        ...
        data: {
          ...
          sortList: [
            ...
            { id: 'institutional_quota', name: '投资规模' },
          ],
          queryModel: {
            'pageParam': {
              'current': 1,
        ...
        methods: {
          ...
          queryList() {
            let _this = this;
            indexApi.pageInvestmentInfo(this.queryModel).then(function (res) {
              if (!res.code) {
