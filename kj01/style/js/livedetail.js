...
require(['/common/js/require.config.js'], function () {
  require(['jquery', 'dic', 'vue', 'httpVueLoader', '/style/js/api/livelist.js', 'fileSaver', 'httpUrl'],
      ...
      new Vue({
        ...
        data: {
          ...
          breadcrumb: [
            ...
            // },
            {
              url: '/livelist.html?type=218340665870780082',
              label: '政策直播间'
            },
            {
              label: '详情'
        ...
        components: {
          ...
          'live_sub_head': httpVueLoader('/style/components/live_sub_head.vue'),
