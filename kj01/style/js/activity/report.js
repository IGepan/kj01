...
require([baseUrlPath + '/common/js/require.config.js'], function () {
  require(['jquery', 'vue', 'dic', 'httpVueLoader', 'userCenter', 'httpUser', '/style/js/api/activity.js', 'jqValidate', 'dialog', 'httpUrl', 'laydate', 'VueUeditor'], function ($, Vue, dic, httpVueLoader, userCenter, httpUser, activityApi, jqValidate, dialog, httpUrl, laydate, VueUeditor) {
          ...
          $('.valiform').validate('submitValidate', function (val) {
            if (val) {
              ...
              activityApi[type](data).then(function (res) {
                if (res.code === 'rest.success') {
                  setTimeout(() => {
                    location.href = '/activity/?code=001.004.001.001'
                  }, 2000);
                } else {
