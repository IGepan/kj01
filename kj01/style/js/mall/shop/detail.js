...
require([baseUrlPath + '/common/js/require.config.js'], function () {
    require(['httpUrl', 'jquery', 'vue', 'dic', 'httpVueLoader', 'httpStoret01', 'dialog', 'fileSaver', 'httpCom', 'httpCartApi'],
        function (httpUrl, $, Vue, dic, httpVueLoader, httpStoret01, dialog, fileSaver, httpCom, httpCartApi) {
