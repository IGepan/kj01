							...
							if (res.code === 'rest.success') {
								vm.$nextTick(function () {
                                    ...
                                    vm.activeLists.forEach(function (items) {
										...
										items.joinNumTotal=(items.pageViews?parseInt(items.pageViews):0)
									})
								})
							}
						})
					...
					getNewActiveList: function () {
						...
						indexApi.selectIssuePage({
							...
							if (res.code === 'rest.success') {
								...
								vm.$nextTick(()=>{
									$(".recent-news").slide({mainCell:".bd ul",autoPlay:true,effect:"leftMarquee",interTime:30,vis:6,trigger:"click"});
								})
							}
						})
					},
